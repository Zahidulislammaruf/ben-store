...
const Footer = () => {
  ...
  <nav>
    ...
    <Link to='/privacy'><a className="link link-hover">Privacy policy</a></Link>
    <Link to='/cookies'><a className="link link-hover">Cookie policy</a></Link>
  </nav>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Ben Store <br/>Providing reliable Product since 2023</p>
  </aside> 
